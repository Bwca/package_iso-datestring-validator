...
describe('Original tests, pretty heavy', () => {
...
describe('Issue 30, 0 in day number', () => {
  test(`${isValidDate.name}. expect function to return false, if a day is 0`, () => {
    // Arrange
    const date = '2022-02-00';
    let result: boolean;
  ...
  test(`${isValidDate.name}. expect function to return false, if a month is 0`, () => {
    // Arrange
    const date = '2022-00-01';
    let result: boolean;
